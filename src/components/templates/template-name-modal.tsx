    ...
    <AppModal open={open} onClose={onClose} title={title} panelClassName="max-w-md">
      ...
      <div className="mt-5 flex justify-end gap-2">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-lg bg-accent px-4 py-2 text-sm font-medium text-background transition hover:opacity-90 disabled:opacity-60"
        >
