...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-[#2a2a2a] bg-transparent text-muted transition hover:bg-[#141414] hover:text-foreground"
    >
      {!mounted ? (
